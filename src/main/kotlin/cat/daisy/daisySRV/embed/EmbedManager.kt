 ...
 */
class EmbedManager(private val config: FileConfiguration) {
     ...
     */
    fun areEmbedsEnabled(): Boolean {
        return config.getBoolean(CONFIG_EMBED_ENABLED, true)
    }
     ...
     * @return The created MessageEmbed
     */
    fun createAchievementEmbed(playerName: String, achievementName: String, achievementDescription: String): MessageEmbed {
     ...
     * @return The created MessageEmbed
     */
    fun createServerStatusEmbed(online: Boolean, playerCount: Int = 0, maxPlayers: Int = 0): MessageEmbed {
     ...
     * @return The created MessageEmbed
     */
    fun createPlayerListEmbed(playerCount: Int, maxPlayers: Int, playerList: List<String>): MessageEmbed {
     ...
     */
    private fun getColorFromConfig(path: String, defaultColor: Color): Color {
